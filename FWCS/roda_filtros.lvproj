...
<Project Type="Project" LVVersion="18008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="ECP" Type="Folder">
			<Item Name="CM_Log File.lvclass" Type="LVClass" URL="../ECP/Log File/CM_Log File.lvclass"/>
			<Item Name="CM_RxTx.lvclass" Type="LVClass" URL="../ECP/RxTx/CM_RxTx.lvclass"/>
			<Item Name="Socket.lvclass" Type="LVClass" URL="../ECP/Socket/Socket.lvclass"/>
			<Item Name="socket PUB.lvclass" Type="LVClass" URL="../ECP/socket PUB/socket PUB.lvclass"/>
			<Item Name="socket REP.lvclass" Type="LVClass" URL="../ECP/socket REP/socket REP.lvclass"/>
			<Item Name="socket REQ.lvclass" Type="LVClass" URL="../ECP/socket REQ/socket REQ.lvclass"/>
			<Item Name="socket SUB.lvclass" Type="LVClass" URL="../ECP/socket SUB/socket SUB.lvclass"/>
			<Item Name="CM_State Machine.lvclass" Type="LVClass" URL="../ECP/State Machine/CM_State Machine.lvclass"/>
			<Item Name="socket.cfg" Type="Document" URL="../ECP/CFG file/socket.cfg"/>
